...
# Broj rata
broj_rata_text = StringVar()
broj_rata_label = Label(app, text='Broj rata', font=('bold', 14))
broj_rata_label.grid(row=1, column=0, sticky=W)
...
datum_prve_rate_label.grid(row=1, column=2, sticky=W)
datum_prve_rate_entry = Entry(app, textvariable=datum_prve_rate_text)
datum_prve_rate_entry.grid(row=1, column=3)
# Ukupan iznos
ukupan_iznos_text = StringVar()
ukupan_iznos_label = Label(app, text='Ukupan iznos', font=('bold', 14))
ukupan_iznos_label.grid(row=1, column=4, sticky=W)
ukupan_iznos_entry = Entry(app, textvariable=ukupan_iznos_text)
ukupan_iznos_entry.grid(row=1, column=5)
# Parts List (Listbox)
parts_list = Listbox(app, height=12, width=80, border=0)
parts_list.grid(row=3, column=0, columnspan=5, rowspan=5)
# Create scrollbar
